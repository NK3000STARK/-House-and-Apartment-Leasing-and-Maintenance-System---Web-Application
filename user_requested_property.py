...
q1 = """select * from purchased_property where user_email = '%s' and status = 'request'""" % uemail
cur.execute(q1)
rec1 = cur.fetchall()
                                    ...
                                    <div class="card card-body mt-5" style="overflow:auto;text-wrap: nowrap;">
                                       <table class="table table-bordered table-responsive">
                                         <tr class="bg-dark text-light">
                                           ...
                                           <th>Owner Name</th>
                                           <th>Mobile</th>
                                           <th style = "text-wrap:wrap">Property Type</th>
                                           <th>Owner Email</th>
                                           <th style = "text-wrap:wrap">Plot/Home Number</th>                        
                                           <th>Rent</th>
                                           <th>Deposit</th>
...
for i in rec1:
        ...
        print("""
                                        ...
                                        <tr>
                                          <td><input name ="fid" value= "%s" style = "border:none;background:transparent;width:30px"></td>
                                          <td><input name ="pname" value= "%s" style = "border:none;background:transparent;text-wrap:wrap;width:120px"></td>
                                          <td>%s</td>
                                          <td>%s</td>
                                          <td>%s</td>
                                          <td>%s</td>
        ...
        i[0], i[1], i[2], i[3], i[4],i[5],i[7],i[12],i[13],i[0],i[0],i[6],i[8],i[9],i[10],i[11],i[14],i[15],i[16],i[17],fn1))