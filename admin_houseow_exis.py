...
q = """select * from ownerregform where status = 'Approve'  """
cur.execute(q)
rec = cur.fetchall()
print("""<!DOCTYPE html>
<html lang="en" >
...
for i in rec:
                  ...
                  <div class="modal-dialog">
                    ...
                    >
                      ...
                      <div class="modal-body">
                          ...
                          <div class="form-group input-group" >
                            <div class="input-group-prepend">
                              <span class="input-group-text" id="basic-addon1">Identity</span>
                            </div>
    ...
    """ % (i[0],fn,i[1],i[2],i[3],i[6],i[8],i[9],i[7],i[5],i[0],i[0],i[8],i[9],i[7],fn1))

    Reject = form.getvalue("new")
    if Reject != None:
        q = """update ownerregform set status = '%s' where id = '%s' """ % (Reject, i[0])
        cur.execute(q)
        con.commit()
        fromadd = "snandhu712@gmail.com"
        password = "rpqdkhnufllixgtq"
        toadd = i[3]
        subject = "House Owner rejection regading"
        body = "Your rejected by admin now you can't add property  ---> {}".format(i[3])
        msg = "Subject : {} \n\n {} ".format(subject, body)
        ...
        print("""
                    <script>
                    alert("House Owner Rejected the property")
                    </script>
                    """)