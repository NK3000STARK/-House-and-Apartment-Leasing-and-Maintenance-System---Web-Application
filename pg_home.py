...
q = """select * from property  where propertyType ='Pg' and status = 'Approve'"""
cur.execute(q)
rec = cur.fetchall()
...
if search_submit != None:
    ...
    q1 = """SELECT * FROM property WHERE ((availableBhk = '%s' or  city ='%s') and rent <= '%s') and propertyType ='Pg'   """ % (
    ...
    if onebhk != None and twobhk != None and threebhk != None:
        q1 = """select * from property where (rent <= %s ) and propertyType ='Pg' """ % filter
        cur.execute(q1)
        record = cur.fetchall()
    ...
    if onebhk != None and twobhk != None and threebhk == None:
        q1 = """select * from property where (rent <= %s ) and availableBhk != '3 bhk' and propertyType ='Pg';""" % filter
        cur.execute(q1)
        record = cur.fetchall()
    ...
    if onebhk != None and twobhk == None and threebhk != None:
        q1 = """select * from property where (rent <= %s ) and availableBhk != '2 bhk' and propertyType ='Pg';""" % filter
        cur.execute(q1)
        record = cur.fetchall()
    ...
    if onebhk == None and twobhk != None and threebhk != None:
        q1 = """select * from property where (rent <= %s ) and availableBhk != '1 bhk'and propertyType ='Pg';""" % filter
        cur.execute(q1)
        record = cur.fetchall()
