...
q = """select * from property  where propertyType ='Apartment' and status = 'Approve'"""
cur.execute(q)
rec = cur.fetchall()
...
if search_submit  != None :
    ...
    q1 = """SELECT * FROM property WHERE ((availableBhk = '%s' or  city ='%s') and rent <= '%s') and propertyType ='Apartment'   """% (search,search,amount)
    cur.execute(q1)
    con.commit()
    ...
    for i in anorecord:
        ...
        print("""
                ...
                """ % (
        i[0], i[0], i[0], i[0], fn, fn, fn, i[0], i[0], i[1], i[16], i[11], i[0], i[2], i[3], i[5], i[16], i[15],
    ...
    if onebhk != None and twobhk != None and threebhk != None:
        q1 = """select * from property where (rent <= %s ) and propertyType ='Apartment' """ % amount
        cur.execute(q1)
        record = cur.fetchall()
    ...
    if onebhk != None and twobhk != None and threebhk == None:
        q1 = """select * from property where (rent <= %s ) and availableBhk != '3 bhk' and propertyType ='Apartment';""" % amount
        cur.execute(q1)
        record = cur.fetchall()
    ...
    if onebhk != None and twobhk == None and threebhk != None:
        q1 = """select * from property where (rent <= %s ) and availableBhk != '2 bhk' and propertyType ='Apartment';""" % amount
        cur.execute(q1)
        record = cur.fetchall()
    ...
    if onebhk == None and twobhk != None and threebhk != None:
        q1 = """select * from property where (rent <= %s ) and availableBhk != '1 bhk'and propertyType ='Apartment';""" % amount
        cur.execute(q1)
        record = cur.fetchall()
    ...
    for i in rec:
        ...
        """ % (i[0],i[0],i[0],i[0],fn, fn, fn,i[0],i[0],i[1], i[16], i[11], i[0],i[2], i[3], i[5], i[16], i[15], i[8], i[9], i[10], i[11], i[12], i[7], i[13]))
