                       ...
                       <div class="card text-center" style="width: 20rem;margin-top:20px">
                          <form method = "post" enctype="multipart/form-data">
                            <div class="card-header">
                              <p>Owner Details </p>
                              <img src="%s" alt="" height="100px">
                            </div>
                            <div class="card-body">
                              <p style = "display:none"><input name ="owid" value= "%s" readonly></p>
                              <p>Name : %s</p>
                              <p>Contact : %s</p>
                              <p>Email : %s</p>
                            </div>
                            <div class="card-footer">
                              <button type="submit" name= "viewmore" class="btn btn-primary">View Properties...</button>
                            </div>
                          </form>
                       </div>
...
owid = form.getvalue("owid")
viewmore = form.getvalue("viewmore")

if viewmore != None:
    print("""<script>
    location.href="admin_property_existing_one.py?id='%s'"
    </script>"""% (owid))