...
owid = form.getvalue("id")
w = """select * from ownerregform where id= %s"""%(owid)
cur.execute(w)
hodet = cur.fetchall()
                                    ...
                                    <div class="card card-body mt-5" style="overflow:auto;text-wrap: nowrap;">
                                       <table class="table table-bordered table-responsive">
                                         <tr class="bg-dark text-light">
                                           <th>ID</th>
                                           <th style = "width:80px;text-wrap:wrap">TENENTS PROFILE</th>
                                           <th>NAME</th>
                                           <th>MOBILE</th>
                                           <th>EMAIL</th>
                                           <th style = "width:80px;text-wrap:wrap">PROPERTY NAME</th>
                                           <th>OWNER NAME</th>
                                           <th>PROPERTY TYPE</th>
                                           <th style = "width:110px;text-wrap:wrap">PROPERTY RENT</th>
...
for i in rec1:
                      ...
                      <div class="modal-body">
                          <div class="form-group input-group" >
                            <div class="input-group-prepend">
                              <span class="input-group-text" id="basic-addon1">Owner Email</span>
                            </div>
    ...
    </html>""" % (i[0],fn,i[27],i[28],i[6],i[1],i[2],i[4],i[12],i[0],i[0],i[5],i[9],i[10],i[11],i[14],i[15],i[16],fn1))
