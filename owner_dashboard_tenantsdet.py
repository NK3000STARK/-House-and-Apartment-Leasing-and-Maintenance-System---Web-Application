...
q1 = """select * from purchased_property where owner_email = '%s' and vacancies = 'occupied'""" % owemail
cur.execute(q1)
con.commit()
rec1 = cur.fetchall()
                    ...
                    <div class="container-fluid" >
                        <div class="row justify-content-center">
                            <div class="col-sm-12 col-lg-12 col-md-10">
                                ...
                                <div id="acceptdiv" >
                                    <div class="card card-body mt-3" style="overflow:auto;text-wrap: nowrap;">
                                        <p>Current tenants</p>
                                       <table class="table table-bordered table-responsive">
                                         <tr class="bg-dark text-light">
                                           <th>ID</th>
                                           <th>TENENTS PROFILE</th>
                                           <th>NAME</th>
                                           <th>MOBILE</th>
                                           <th>EMAIL</th>
                                           <th>PROPERTY NAME</th>
                      ...
                      <div class="modal-body">
                          <div class="form-group input-group" >
                            <div class="input-group-prepend">
                              <span class="input-group-text" id="basic-addon1">Plot No</span>
                            </div>
                          ...
                          <div class="form-group input-group" >
                            <div class="input-group-prepend">
                              <span class="input-group-text" id="basic-addon1">Deposite</span>
                            </div>
                            <input type="text" class="form-control" value = "%s"readonly><br>
                          </div>
                          <div class="form-group input-group" >
...
""" % (i[0],fn,i[27],i[28],i[6],i[1],i[25],i[26],i[4],i[12],i[0],i[0],i[7],i[8],i[9],i[10],i[11],i[13],i[14],i[15],i[16],fn1))
print("""</table>""")
...
q1 = """select * from purchased_property where owner_email = '%s' and vacancies = 'vacant'""" % owemail
cur.execute(q1)
con.commit()
rec1 = cur.fetchall()
for i in rec1:
...
""" % (i[0], fn, i[27], i[28], i[6], i[1], i[30], i[4], i[12], i[0], i[0], i[7], i[8], i[9], i[10], i[11], i[13], i[14],
       i[15], i[16], fn1))
print("""</table>""")