...
for i in rec:
    ...
    <td><input type="text" name ="fid" value= "%s" style = "border:none;background:transparent;width:80px" readonly></td>
    <td><input type="text" name ="fname" value= "%s" style = "border:none;background:transparent;width:80px" readonly></td>
    <td><input type="text" name ="femail" value= "%s" style = "border:none;background:transparent;" readonly></td>
    <td><input type="text" name ="fpass" value= "%s" style = "border:none;background:transparent;width:80px" readonly></td>
    <td>
...
if Approve != None:
    ...
    print("""
                ...
                location.href="admin_forgot_pass.py"
                </script>
                """)

if Reject != None:
    q = """update forgot_pass set status = '%s' where id = '%s' """%(Reject,fid)
    cur.execute(q)
    con.commit()
    fromadd = "snandhu712@gmail.com"
    password = "rpqdkhnufllixgtq"
    toadd = femail
    subject = "User Name and Password regarding"
    body = " Admin Can't Provide You an username and passsword"
    msg = "Subject : {} \n\n {} ".format(subject, body)
    server = smtplib.SMTP("smtp.gmail.com:587")
    server.ehlo()
    server.starttls()
