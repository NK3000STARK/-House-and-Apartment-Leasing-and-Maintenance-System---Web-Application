...
q1 ="""select * from purchased_property where user_email = '%s' and status = 'Approve'"""% uemail
cur.execute(q1)
rec1 = cur.fetchall()
...
<p>%s</p>
<form method = "post" enctype="multipart/form-data">
<select name = "owname" class = "form-control ml-3" style = "width:500px">
<optgroup label = "select owner name">
"""%(pname,owname))
for j in rec1:
    print("""
...
print("""
<p class = "mt-3">Select property Name :</p>
<select name = "property_Name" class = "form-control ml-3" style = "width:500px">
             <optgroup label = "slect property name">
                                      ...
                                      <div class= "row">
                                          <div class = "col mt-2">
                                                <textarea
                                                  ...
                                                  rows="8"
                                                  class="form-control"
                                                  placeholder="Enter Your Maintanance Request......"
                                                ></textarea>
...
reqsubmit = form.getvalue("submit")

if reqsubmit != None:
    owname = form.getvalue("owname")
    pname = form.getvalue("property_Name")
